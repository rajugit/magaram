...
const permissions = [
  ...
  { code: 'market:own', description: 'Create and manage owned marketplace listings.' },
  { code: 'market:review', description: 'Review marketplace listings and reports.' },
  { code: 'market:manage', description: 'Manage marketplace listings and moderation.' },
...
const roles = [
  ...
  { code: 'ADMIN', name: 'Administrator', permissions: ['settings:read', 'audit:read'] },
  {
    code: 'EDITOR',
    name: 'Editor',
    permissions: ['articles:draft', 'articles:review', 'ads:review', 'market:review'],
  },
  ...
  { code: 'RECRUITER', name: 'Recruiter', permissions: ['market:own'] },
