...
for attempt in $(seq 1 30); do
  if curl --fail --silent http://127.0.0.1:3000/preview/8 >/dev/null && curl --fail --silent http://127.0.0.1:4000/api/v1/ads/public >/dev/null && curl --fail --silent http://127.0.0.1:4000/ready >/dev/null && curl --fail --silent http://127.0.0.1:3000/preview/3 >/dev/null && curl --fail --silent http://127.0.0.1:3000/preview/4 >/dev/null && curl --fail --silent http://127.0.0.1:3000/preview/7 >/dev/null && curl --fail --silent http://127.0.0.1:3000/preview/7/workspace >/dev/null && curl --fail --silent http://127.0.0.1:3000/local >/dev/null && curl --fail --silent http://127.0.0.1:4000/api/v1/local/businesses >/dev/null && curl --fail --silent http://127.0.0.1:3000/news >/dev/null && curl --fail --silent http://127.0.0.1:3000/news/category/local >/dev/null && curl --fail --silent http://127.0.0.1:3000/news/location/chennai >/dev/null && curl --fail --silent http://127.0.0.1:3000/robots.txt >/dev/null && curl --fail --silent http://127.0.0.1:3000/sitemap.xml >/dev/null && curl --fail --silent http://127.0.0.1:3000/rss.xml >/dev/null && curl --fail --silent http://127.0.0.1:3000/news-sitemap.xml >/dev/null && test "$(docker inspect -f '{{.State.Running}}' magaram-worker-1)" = true; then
